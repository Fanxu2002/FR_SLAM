// ============================================================================
// AUTO-GENERATED LOCAL PORT FOR FR-SLAM.
//
// Upstream: https://github.com/hku-mars/btc_descriptor
// Commit  : 742af157036144edad9a8350330c0158ea1a40d5
//
// Algorithmic BTC code is kept from upstream. This generated copy removes only
// the ROS1 visualization/publisher shell and adds compatibility needed by the
// Ubuntu 22.04 / Ceres 2.0 environment.
// Do NOT edit manually; regenerate with apply_official_btc_v27.py.
// ============================================================================

#ifndef FR_SLAM_OFFICIAL_BTC_CORE_HPP
#define FR_SLAM_OFFICIAL_BTC_CORE_HPP
...
class BtcDescManager {
 public:
  ...
  //
  // NORMAL:
  //     candidate_selector rough vote >= 5
  //
  // PENDING rescue:
  //     only historical BTC frames inside this range may use rough vote >= 3.
  //
  // candidate_verify() is intentionally NOT relaxed here.
  void SetPendingRescueRange(
      int historical_frame_min,
      int historical_frame_max)
  {
    pending_rescue_enabled_ =
        historical_frame_min >= 0 &&
        historical_frame_max >= historical_frame_min;

    pending_rescue_frame_min_ =
        pending_rescue_enabled_
            ? historical_frame_min
            : -1;

    pending_rescue_frame_max_ =
        pending_rescue_enabled_
            ? historical_frame_max
            : -1;
  }

  void ClearPendingRescueRange()
  {
    pending_rescue_enabled_ = false;
    pending_rescue_frame_min_ = -1;
    pending_rescue_frame_max_ = -1;
  }
 ...
 private:
  // FR-SLAM V31.11 pending-local rough retrieval rescue.
  bool pending_rescue_enabled_ = false;
  int pending_rescue_frame_min_ = -1;
  int pending_rescue_frame_max_ = -1;
...
#endif  // FR_SLAM_OFFICIAL_BTC_CORE_HPP