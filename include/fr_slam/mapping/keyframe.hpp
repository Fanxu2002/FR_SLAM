...
struct Keyframe
{
    ...
    // BTC-specific dense historical snapshot in the original LiDAR frame.
    //
    // This cloud is captured before the normal registration Voxel/SOR/ROR
    // chain. It is used ONLY to build BTC Submaps. Frontend registration,
    // LocalMap, LoopVerifier targets and PoseGraph behavior keep using `cloud`.
    pcl::PointCloud<LIDAR_POINT>::Ptr btc_cloud =
        pcl::make_shared<pcl::PointCloud<LIDAR_POINT>>();
// ========================================================================
