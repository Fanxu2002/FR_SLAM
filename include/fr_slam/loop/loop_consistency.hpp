...
struct LoopConsistencyConfig
{
    ...
    // because BTC Submap retrieval does not guarantee exact +1 Keyframe matches.
    // ------------------------------------------------------------------------
    bool use_temporal_consistency = false;

    std::size_t temporal_max_current_gap = 4;

    std::size_t temporal_max_historical_gap = 4;
    ...
    // ------------------------------------------------------------------------
    bool use_cycle_consistency = false;
